...
inFiles="input_files_newGEN_GUN.dat"
...
echo "cmsRun -e -j FrameworkJobReport.xml step3_GEN-SIM-DIGI_inputNEWGEN_cfg.py jobId=$1 inputFile=$outputNameMINIAODTmp outputFile=$outputNameRAW inputPremix=$inputPremix"
cmsRun -e -j FrameworkJobReport.xml step3_GEN-SIM-DIGI_cfg.py jobId=$1 inputFile=$outputNameMINIAODTmp outputFile=$outputNameRAW inputPremix=$inputPremix
