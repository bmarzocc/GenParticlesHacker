...
inFiles="input_files_stdGEN_GUN.dat"
...
cmsRun -e -j FrameworkJobReport.xml NewGeneratorProducer_cfg.py inputFile=$inputFile outputFile=$outputName
...
cmsRun -e -j FrameworkJobReport.xml GeneratorLabelChanger_cfg.py inputFile=$outputNameTmp outputFile=$outputName
