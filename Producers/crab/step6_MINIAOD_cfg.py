...
# with command line options: --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --conditions 106X_upgrade2018_realistic_v16_L1v1 --step PAT --geometry DB:Extended --era Run2_2018 --procModifiers run2_miniAOD_UL --python_filename B2G-RunIISummer20UL18MiniAODv2-06746_1_cfg.py --fileout file:B2G-RunIISummer20UL18MiniAODv2-06746.root --filein file:B2G-RunIISummer20UL18RECO-06746.root --number 1000 --runUnscheduled --no_exec --mc
...
process.MINIAODSIMoutput.outputCommands.extend(['keep *_*_*_*GEN*'])
